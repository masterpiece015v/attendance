...
import tokyo.mstp015v.timetable_pro.databinding.FragmentSettingBinding
...
class SettingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //科目修正に移動
        binding.textEditTimeTableColor.setOnClickListener {
            val action = SettingFragmentDirections.actionEditTimeTableColorFragment2()
            findNavController().navigate( action )
        }
