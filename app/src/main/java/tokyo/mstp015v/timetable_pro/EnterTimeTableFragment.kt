...
import tokyo.mstp015v.timetable_pro.databinding.FragmentEnterTimeTableBinding
import tokyo.mstp015v.timetable_pro.realm.TimeTableDetail
import tokyo.mstp015v.timetable_pro.tools.CalendarDialog
import java.util.*


class EnterTimeTableFragment : Fragment() {

    private val args : EnterTimeTableFragmentArgs by navArgs()
    private var _binding : FragmentEnterTimeTableBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEnterTimeTableBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textDate.setOnClickListener {
            val ret = realm.where<TimeTableDetail>().equalTo("g_name",args.gName )
