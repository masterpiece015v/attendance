...
import tokyo.mstp015v.timetable_pro.databinding.FragmentMakeTimeTableBinding
...
class MakeTimeTableFragment : Fragment() {
    ...
    inner class MakeDaysAdapter( fa: FragmentActivity? ): FragmentStateAdapter( fa!! ){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.viewPagerMakeTimeTable.adapter = MakeDaysAdapter( activity)
